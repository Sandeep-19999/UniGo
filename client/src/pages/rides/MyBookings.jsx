        ...
        {bookings.length === 0 ? (
          <div className="bg-white rounded-lg shadow-lg p-12 text-center">
            ...
            <p className="text-gray-600">
              You haven't made any ride requests yet. Start by searching for a ride!
            </p>
          </div>
        ) : (
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4 py-4 border-y border-gray-200">
                    <div>
                      ...
                      <p className="text-xs text-gray-600">
                        Time: {Math.round(Number(booking.timeMin || 0))} min
                      </p>
                      <p className="text-xs text-gray-700 font-semibold">
                        Estimated Fare: Rs. {Number(booking.estimatedFare ?? booking.estimatedPrice ?? 0).toFixed(2)}
                      </p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-gray-800">
                        {booking.acceptedBy?.name || "Waiting for driver..."}
                      </p>
                    </div>
                    <div>
                  ...
                  <div className="flex gap-3">
                    ...
                    {booking.status === "completed" && (
                      <button
                        onClick={() => handleRateDriver(booking._id)}
                    ...
                    {booking.status === "cancelled" && (
                      <button className="flex-1 bg-gray-300 text-gray-600 font-semibold py-2 rounded-lg cursor-not-allowed">
                        Request Cancelled
                      </button>
                    )}
                  </div>
